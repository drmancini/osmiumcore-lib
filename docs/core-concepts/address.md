...
Represents a osmium address. Addresses are the most popular way to make osmium transactions. See [the Dash documentation](https://dash-docs.github.io/en/glossary/address) for technical background information.
